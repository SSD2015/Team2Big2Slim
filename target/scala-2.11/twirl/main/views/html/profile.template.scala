            ...
            <div class="row">
                ...
                <div class="col-xs-8">
                    <div class = "Information">
                        ...
                        <h4 style="font-family:verdana" >Member:</h4>
                        """),_display_(/*92.26*/member/*92.32*/.map/*92.36*/ { person =>_display_(Seq[Any](format.raw/*92.48*/("""
                         """),format.raw/*93.26*/("""<p>"""),_display_(/*93.30*/person/*93.36*/.name),format.raw/*93.41*/(""" """),_display_(/*93.43*/person/*93.49*/.surname),format.raw/*93.57*/(""" """),_display_(/*93.59*/person/*93.65*/.kuNo),format.raw/*93.70*/("""</p>
                     """)))}),format.raw/*94.23*/("""
                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <button class = "Picture"> <img src= """),_display_(/*129.75*/project/*129.82*/.sc1),format.raw/*129.86*/(""" """),format.raw/*129.87*/("""alt="Chania" width="553.5" height="345" onclick="location.href='http://localhost:9000/screenshot1/' + """),_display_(/*129.190*/project/*129.197*/.id),format.raw/*129.200*/(""""> </button>
                                </div>
                                <div class="item">
                                    <button class = "Picture"> <img src= """),_display_(/*132.75*/project/*132.82*/.sc2),format.raw/*132.86*/(""" """),format.raw/*132.87*/("""alt="Chania" width="553.5" height="345" onclick="location.href='http://localhost:9000/screenshot2/' + """),_display_(/*132.190*/project/*132.197*/.id),format.raw/*132.200*/(""""> </button>
                                </div>
                                <div class="item">
                                    <button class = "Picture"> <img src= """),_display_(/*135.75*/project/*135.82*/.sc3),format.raw/*135.86*/(""" """),format.raw/*135.87*/("""alt="Flower" width="553.5" height="345" onclick="location.href='http://localhost:9000/screenshot3/' +  """),_display_(/*135.191*/project/*135.198*/.id),format.raw/*135.201*/(""""> </button>
                                </div>
                            </div>
