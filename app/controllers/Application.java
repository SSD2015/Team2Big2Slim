...
public class Application extends Controller {
    ...
    public static Result mockDatabase() {
        Project.create(1,"2Big2Slim","http://static.sportskeeda.com/wp-content/uploads/2014/08/gta-v-1409058623.jpg","App",
...
//        Member.create(5,"Nut","Kaewnak","5610545676",(long)2);
        ...
        //project 1
        User.create(2, "b5610545722", "punpikorn.r", "Punpikorn", 1, "5610545722");
        User.create(3, "b5610545668", "nathakorn.s", "Nathakorn", 1, "5610545668");
        User.create(4, "b5610545731", "piyaphat.t", "Piyaphat", 1, "5610545731");
        User.create(5, "b5610546711", "nabhat.y", "Nabhat", 1, "5610546711");
        User.create(6, "b5610545676", "nut.k", "Nut", 1, "5610545676");
