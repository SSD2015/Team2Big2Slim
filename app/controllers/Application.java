...
//        System.out.println("This user = " + currentUser.username);
    ...
    public static Result mockDatabase() {
        ...
        Project.create("Saint4", picProject1, "App", ss1, ss2, ss3, "This is a project1 description. Something is here.");
        Project.create("Manat", picProject2, "App", ss1, ss2, ss3, "This is a project2 description. Something is here.");
        Project.create("2Big2Slim", picProject3, "App", ss1, ss2, ss3, "This is a project3 description. Something is here.");
        Project.create("Fatcat", picProject4, "App", ss1, ss2, ss3, "This is a project4 description. Something is here.");
        ...
        RatingCriteria.create("Completeness");
        RatingCriteria.create("Security");
        RatingCriteria.create("Quality of UI");
        //vote criteria
		VotingCriteria.create("Best of Exceed Camp");
